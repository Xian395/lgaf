...
const props = defineProps({
    ...
    color: {
        type: String,
        default: '', // Default to blue button
    },
    size: {
        type: String,
...
const buttonClasses = computed(() => {
    const size = sizeClasses[props.size] || sizeClasses.md; // Default to 'md'
    const colorMap = {
        add: 'green',
        delete: 'red',
        edit: 'green',
    ...
    return classes || colorClasses(size).blue; // Fallback to blue if color is invalid
});
