<template>
    ...
    <div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
        ...
        <!-- Main Content -->
        <main class="relative z-10 flex-1 flex items-center justify-center pt-8 pb-12 px-4 sm:px-6 lg:px-8">
            <div class="max-w-md w-full space-y-8">
                <!-- Page Title -->
                <div class="text-center">
                    <h2 class="text-3xl font-bold text-gray-900 mb-2">Citizen Services Portal</h2>
                    <p class="text-gray-600">Secure access to government services</p>
                </div>
                    ...
                    <div class="mt-8">
                        <div class="relative">
                            ...
                            <div class="relative flex justify-center text-sm">
                                <span class="px-4 bg-white text-gray-500">New to the portal?</span>
                            </div>
                        </div>
                    </div>
