    ...
    <ResidentLayout>
        ...
        >
            ...
            <div class="fixed inset-0 overflow-hidden pointer-events-none">
                <div
                    class="absolute top-1/4 left-1/4 w-2 h-2 bg-blue-300 rounded-full opacity-20 animate-pulse"
                ></div>
                <div
                    class="absolute top-1/3 right-1/3 w-3 h-3 bg-indigo-300 rounded-full opacity-30 animate-bounce"
                ></div>
                <div
                    class="absolute bottom-1/4 left-1/3 w-1 h-1 bg-purple-300 rounded-full opacity-40 animate-ping"
                ></div>
            </div>
            ...
            <div class="relative max-w-4xl mx-auto">
                ...
                <!-- Main form card -->
                <div
                    class="bg-white/80 backdrop-blur-sm shadow-2xl border border-white/20 overflow-hidden transition-all duration-500 hover:shadow-3xl"
                >
                    <!-- Header section with gradient -->
                    <div
                        class="bg-gradient-to-r from-indigo-600 via-purple-600 to-blue-600 p-8 text-white relative overflow-hidden"
                    >
                        <div class="absolute inset-0 bg-black/10"></div>
                        <div class="relative z-10">
                            <div class="flex items-center justify-center mb-4">
                                <div
                                    class="p-3 bg-white/20 rounded-full backdrop-blur-sm"
                                >
                                    <svg
                                        class="w-8 h-8"
                                        fill="currentColor"
                            ...
                            <h1
                                class="text-4xl font-bold text-center mb-4 tracking-tight"
                            >
                                Share Your Experience
                            </h1>
                            <p
                                class="text-xl text-center text-white/90 leading-relaxed max-w-2xl mx-auto"
                            >
                                Your feedback helps us deliver exceptional
                                service. Every response matters.
                            </p>
                        </div>
                    </div>
                        ...
                        <form @submit.prevent="submit" class="space-y-10">
                            ...
                            <div class="group">
                                <div class="text-center mb-6 sm:mb-8">
                                    ...
                                    >
                                        Click on the stars to rate your
                                        experience
                                    </p>
                                </div>

                                <div
                                    class="flex justify-center items-center mb-4 sm:mb-6"
                                >
                                    <div class="flex space-x-1 sm:space-x-2">
                                        <button
                                            ...
                                            class="text-4xl sm:text-5xl md:text-6xl lg:text-7xl transition-all duration-200 transform hover:scale-110 focus:outline-none focus:ring-4 focus:ring-indigo-300 rounded-lg p-1 sm:p-2"
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="flex justify-center">
                                        <div
                                            class="px-3 py-2 sm:px-4 bg-indigo-50 rounded-full"
                                        >
                                            <span
                                                class="text-sm sm:text-base text-indigo-600 font-medium"
                                            >
                                                {{
                                                    form.rating
                            ...
                            <div class="flex items-center justify-center my-8">
                                <div
                                    class="h-px bg-gradient-to-r from-transparent via-gray-300 to-transparent w-full"
                                ></div>
                                <div class="px-4">
                                    <div
                                        class="w-3 h-3 bg-indigo-500 rounded-full animate-pulse"
                                    ></div>
                                </div>
                                <div
                                    class="h-px bg-gradient-to-r from-transparent via-gray-300 to-transparent w-full"
                            ...
                            <div class="group">
                                <div class="mb-6">
                                    <h3
                                        class="text-xl font-semibold text-gray-800 mb-2 flex items-center"
                                    >
                                        <svg
                                        ...
                                        >
                                            <path
                                                d="M16 4c0-1.11.89-2 2-2s2 .89 2 2-.89 2-2 2-2-.89-2-2zm4 18v-6h2.5l-2.54-7.63A2.001 2.001 0 0 0 17.5 7h-3c-.8 0-1.5.7-1.5 1.5v6c0 .8.7 1.5 1.5 1.5h2v6h4z"
                                            />
                                        </svg>
                                        Was the staff courteous and helpful?
                                    </h3>
                                    <p class="text-gray-600">
                                        Tell us about your interaction with our
                                        team
                                    </p>
                                </div>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <span
                                                class="text-lg font-medium text-center block"
                                                >{{ option }}</span
                                            >
                                        </div>
                                    </label>
                                ...
                                <InputError
                                    class="mt-3"
                                    :message="form.errors.courteous_staff"
                                />
                            </div>
                            ...
                            <div class="group">
                                <div class="mb-6">
                                    ...
                                    <p class="text-gray-600">
                                        Help us understand our service
                                        efficiency
                                    </p>
                                </div>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <span
                                                class="text-base font-medium text-center block"
                                                >{{ option }}</span
                                            >
                                        </div>
                                    </label>
                            ...
                            <div class="group">
                                <div class="mb-6">
                                    ...
                                    <p class="text-gray-600">
                                        Your feedback on process clarity
                                    </p>
                                </div>
                                ...
                                <InputError
                                    class="mt-3"
                                    :message="form.errors.easy_to_understand"
                                />
                            </div>
                ...
                >
                    <div
                        class="bg-white rounded-3xl p-8 max-w-md mx-4 text-center animate-bounce"
                    >
                        <div
...
const submit = () => {
    form.post(route("resident.experience.store"), {
        onSuccess: () => {
            ...
            notifyMinimal(
                "Your responce has been submitted successfully!!",
                "success"
            );
        },
        onError: () => {
