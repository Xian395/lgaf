                        ...
                        <form @submit.prevent="submit" class="space-y-10">
                            ...
                            <div class="group">
                                <div class="text-center mb-8">
                                    <h3
                                        class="text-2xl font-semibold text-gray-800 mb-2 flex items-center justify-center"
                                    >
                                        <svg
                            ...
                            <div class="group">
                                <div class="mb-6">
                                    ...
                                    <p class="text-gray-600">
                                        Share your thoughts and suggestions to
                                        help us improve
                                    </p>
                                </div>
